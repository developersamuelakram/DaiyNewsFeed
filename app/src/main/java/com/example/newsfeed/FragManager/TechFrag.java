...
public class TechFrag extends Fragment implements LoaderManager.LoaderCallbacks<List<Model>> {

    private static final String TECH_API =
            "http://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=6a6f7c77766442acb20c86157a152131 ";
    public static final String API_KEY = "6a6f7c77766442acb20c86157a152131";

    private Adapter mAdapter;
    RecyclerView recyclerView;
    List<Model> newsList;
    private static final int TECH_LOADER = 3;
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            if (connectivityManager != null) {
                ...
                if (networkInfo != null) {
                    ...
                    loaderManager.initLoader(TECH_LOADER, null, this);
                    ...
                    if (loaderManager.restartLoader(TECH_LOADER, null, this).isReset()) {
                        swipeRefreshLayout.setRefreshing(false);
    ...
    public Loader<List<Model>> onCreateLoader(int id, Bundle args) {
        return new QueryLoader(getContext(), TECH_API);
    }
